i="""Sue 1: cars: 9, akitas: 3, goldfish: 0
...
for sue in sues:
	...
	b = True
	for p in aunt.keys():
		if p in ["cats", "trees"] and p in sue and sue[p] <= aunt[p]:
				b = False
				# print sue["n"], "cat"
		elif p in ["pomeranians", "goldfish"] and p in sue and sue[p] >= aunt[p]:
				b = False
				# print sue["n"], "pom"
		elif p in ["children", "samoyeds", "akitas", "vizslas", "cars", "perfumes"] and p in sue and sue[p] != aunt[p]:
				b = False
		if p in sue and sue[p] != aunt[p]:
			a = False
	if a:
		print "aunt a:", sues.index(sue)
	if b:
		print "aunt b:", sues.index(sue)
